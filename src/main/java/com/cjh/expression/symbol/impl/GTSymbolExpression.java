...
/**
 * @author JianhuiChen
 * @description 大于运算 只支持数字
 * @date 2019-11-25
 */
public class GTSymbolExpression extends SymbolExpression<Boolean> {

    public GTSymbolExpression(Expression left, Expression right) {
        super(left, right);
    }
    ...
    private Boolean compute(Object left, Object right) {
        ...
        throw new InterceptException(this, "More then must act on numbers");
    }
}
