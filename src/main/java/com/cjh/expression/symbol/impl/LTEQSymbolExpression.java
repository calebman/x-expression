...
/**
 * @author JianhuiChen
 * @description 小于等于运算 只支持数字
 * @date 2019-11-25
 */
public class LTEQSymbolExpression extends SymbolExpression<Boolean> {

    public LTEQSymbolExpression(Expression left, Expression right) {
        super(left, right);
    }
    ...
    private Boolean compute(Object left, Object right) {
        ...
        throw new InterceptException(this, "Less then or equal must act on numbers");
    }
}
